...
const Task = ({task, handleTaskClick, handleTaskDeletion}) => {
    ...
    return(
        <div className = "task-container" style ={task.completed ? { borderLeft: "6px solid darkorchid" } : {}}
        >
    ...
    // linha comentada Ligia return <div className = "task-container">{task.title}</div>
};
